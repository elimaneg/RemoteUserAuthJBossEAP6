 ...
 * @since Sep 11, 2006
 */
public class HTTPHeaderAuthenticator extends ExtendedFormAuthenticator {
  protected static Logger log = Logger
      .getLogger(HTTPHeaderAuthenticator.class);
   ...
   * </p>
   */
  public HTTPHeaderAuthenticator() {
    super();
  }
